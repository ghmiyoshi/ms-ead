...
public class ApiExceptionHandler {
    ...
    private String createUrl(final HttpStatusCode httpStatusCode) {
        return switch (httpStatusCode.value()) {
            case 400 -> "https://api.notification.com/errors/bad-request";
            case 404 -> "https://api.notification.com/errors/not-found";
            case 500 -> "https://api.notification.com/errors/internal-server-error";
            default -> "https://api.notification.com/errors";
        };
    }
